...
const TITLE = "A/B Testing & Feature Flag Service";
const TAGLINE = "Deterministic hash-based variant assignment, impression/conversion tracking, and z-test significance.";
...
const ENDPOINTS: Endpoint[] = [
  ...
  {
    "label": "Assign user-42",
    "method": "GET",
    "path": "/api/assign?user_id=user-42&experiment=cta_color_test"
  },
  {
    "label": "Track impression (exp 1)",
    "method": "POST",
    "path": "/api/track",
    "body": {
      "experiment_id": 1,
  ...
  },
  {
    "label": "Results (exp 1)",
    "method": "GET",
    "path": "/api/experiments/1/results"
  }
];
